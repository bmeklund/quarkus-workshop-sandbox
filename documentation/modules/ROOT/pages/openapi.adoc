...
[NOTE]
====
If your local instance is not running, restart it by running the devfile task *02. Start Live Coding* or by running the following command in a terminal:
...
Access the new endpoint using the following command:
